...
@simple_user_message_handler(interactive_router, CustomCommandFilter("бонкнуть"))
...
@simple_user_message_handler(interactive_router, CustomCommandFilter("бросить кактус"))
